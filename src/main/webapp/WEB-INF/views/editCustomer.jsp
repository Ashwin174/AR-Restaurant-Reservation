   ...
   <%-- <form:form action="${pageContext.request.contextPath}/showCustomers"
			...
			<div class="form-group">
				...
				<div class="col-md-offset-3 col-md-9">
					<form:button cssClass="btn btnprimary">Return </form:button>
				</div>
			</div>
		...
		<form:form action="${pageContext.request.contextPath}/confirmEdit/"
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<form:input path="name" value ="${currCustomer.name}" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
